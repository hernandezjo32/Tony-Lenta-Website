  ...
  return (
    <section id="music" ref={sectionRef} className="py-24 px-6 relative">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="mb-16 fade-up">
          <div className="glass rounded-2xl p-6 md:p-8">
            ...
            <div className="grid md:grid-cols-2 gap-8 items-start">
              ...
              <div>
                <h3
                  className="font-syne font-extrabold text-4xl md:text-5xl text-white mb-2"
                  style={{ letterSpacing: "-0.02em" }}
                >
                  {LATEST_SINGLE.title}
                </h3>
                <p className="text-gold-300 font-syne tracking-wider text-sm uppercase mb-4">
                ...
                <div className="flex gap-3 flex-wrap">
                  <a
                    ...
                    className="flex items-center gap-2 bg-[#1DB954] text-black font-bold px-5 py-2 rounded-full text-sm font-syne tracking-wider hover:bg-[#1ed760] transition-colors"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-2 bg-[#FF0000] text-white font-bold px-5 py-2 rounded-full text-sm font-syne tracking-wider hover:bg-[#cc0000] transition-colors"
                  >
                    <Play size={16} />
                    <span>YouTube</span>
                  </a>
            ...
            <div className="mt-8">
              ...
              <div className="relative rounded-xl overflow-hidden border border-gold-300/20 group">
                <img
                  src="/tony-live-performance.jpeg"
                  alt="Tony Lenta Live Performance"
                  className="w-full h-auto object-cover transition-transform duration-500 group-hover:scale-105"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-obsidian/80 via-obsidian/20 to-transparent opacity-60 group-hover:opacity-40 transition-opacity" />
        ...
        {/* Classic Tracks Grid */}
        <div>
          <h3 className="font-syne font-bold text-white tracking-widest uppercase text-sm mb-6 flex items-center gap-3 fade-up">
            <span className="gold-divider inline-block w-8 h-px bg-gold-300" />
            Essential Hits
          </h3>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {CLASSIC_TRACKS.map((track, i) => (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="track-card p-5 flex items-center gap-4 group cursor-pointer fade-up"
                aria-label={`Stream ${track.title} on Spotify`}
              >
                <div className="w-10 h-10 rounded-lg bg-gold-300/10 border border-gold-300/20 flex items-center justify-center flex-shrink-0 group-hover:bg-gold-300/20 transition-colors">
