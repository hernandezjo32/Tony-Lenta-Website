...
Important: You can answer questions about Tony Lenta's career, music, upcoming events, streaming links, social media, and booking. For personal questions you don't know the answer to, be honest but keep the energy positive. Never make up fake events or tours unless confirmed.`;
...
export async function POST(request: NextRequest) {
  try {
    ...
    const text = textContent ? textContent.text : "Lo siento, try again!";
